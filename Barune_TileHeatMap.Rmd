...
tileplot <- SR_country %>% ggplot(aes(Month, Country,  fill = sex_ratio)) +
        ...
        scale_x_continuous(name="Month", limits=c(0, 12), breaks = 1:11,
          labels = paste0(c("Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov")),) +
        scale_fill_gradient(low="firebrick1", high="dodgerblue4",limits=c(0,12), breaks = c(0, 1, 4, 8), trans = "sqrt") +
        theme_ipsum() +
        theme_minimal() +  theme(panel.grid = element_blank()) +
        ggtitle("COVID-19 Case Sex Ratio Monthly Averages by Country") + 
        ylab("Country") +
        labs(fill="Sex Ratio 
(M:F)")
